        ...
        function saveRecord(context) {
            try {
                ...
                if (customerId) {
                    ...
                    // Check criteria for displaying alert
                    ...
                    if (
                        ...
                        var alertMessage = 'Record cant be saved! Customer on Credit Hold.';
                        window.alert(alertMessage);
                        return false; // Prevents record from saving
                    }
                }

                return true; // Record saves if criteria not met
